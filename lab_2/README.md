...
Запуск программы при исследовании производился с конфигом, устанавливающим размеры матриц в 200, 400, 600, 800, 1000, 1500, 2000, 2500, 3000, 5000 элементов. Количество потоков при этом изменялось от 1 до 12 (1, 2, 4, 6, 8, 12). Результат запусков приведён в таблице ниже. 
